---
title: "Horizontal analysis of DESIGN"
...
data_src <- read.csv('./data/final_design.csv', row.names = 1, header= TRUE)
...
df$subcategory[df$Category == 'Product Design'] <- 1
df$subcategory[df$Category == 'Graphic Design'] <- 2
df$subcategory[!(df$Category %in% c('Product Design', 'Graphic Design'))] <- 3
...
write.csv(do.call(cbind, lapply(df[c('Pledge_USD', 'degree_of_diff', 'Number_Backers', 'Creator_nb_projects', 'Goal_USD', 'pledged_percentage')], summary)), './docs/design_descriptive.csv')

#df$meta = 'design'
#write.csv(df, './data/adjusted_design.csv')
...
setwd('C:/Gergo-mappa/projects/programming/projects/jads/sbm/jads_2021_g9_sbm')
write.csv(tidy(model1), './docs/design_percentage_model_coefs.csv')
write.csv(glance(model1), './docs/design_percentage_model_glance.csv')
```
...
setwd('C:/Gergo-mappa/projects/programming/projects/jads/sbm/jads_2021_g9_sbm')
write.csv(tidy(model3), './docs/design_pledge_model_coefs.csv')
write.csv(glance(model3), './docs/design_pledge_model_glance.csv')
```
# inverted U
```{r}
xmin = 0; xmax = 1
...
setwd('C:/Gergo-mappa/projects/programming/projects/jads/sbm/jads_2021_g9_sbm')
write.csv(tidy(model_inv_u), './docs/design_inv_u_model_perc_coefs.csv')
write.csv(glance(model_inv_u), './docs/design_inv_u_model_perc_glance.csv')
...
lines(xv, yv, col='red', lwd=2)
setwd('C:/Gergo-mappa/projects/programming/projects/jads/sbm/jads_2021_g9_sbm')
write.csv(tidy(model_inv_u), './docs/design_inv_u_model_pledge_coefs.csv')
write.csv(glance(model_inv_u), './docs/design_inv_u_model_pledge_glance.csv')
```

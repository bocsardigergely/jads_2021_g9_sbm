...
write.csv(do.call(cbind, lapply(df[c('Pledge_USD', 'degree_of_diff', 'Number_Backers', 'Creator_nb_projects', 'Goal_USD', 'pledged_percentage')], summary)), './docs/tech_descriptive.csv')
...
write.csv(glance(model1), './docs/tech_percentage_model_glance.csv')
...
write.csv(glance(model3), './docs/tech_pledge_model_glance.csv')
```
...
setwd('C:/Gergo-mappa/projects/programming/projects/jads/sbm/jads_2021_g9_sbm')
write.csv(tidy(model_inv_u), './docs/tech_inv_u_model_perc_coefs.csv')
write.csv(glance(model_inv_u), './docs/tech_inv_u_model_perc_glance.csv')
...
lines(xv, yv, col='red', lwd=2)
setwd('C:/Gergo-mappa/projects/programming/projects/jads/sbm/jads_2021_g9_sbm')
write.csv(tidy(model_inv_u), './docs/tech_inv_u_model_pledge_coefs.csv')
write.csv(glance(model_inv_u), './docs/tech_inv_u_model_pledge_glance.csv')
```
